...
async function comenzarInteraccion() {
    ...
    if (hora >= 8 && hora <= 12) {
        ...
        // condicional para saber a que hora se esta encontrando el restaurante cerrado
        let hora_apertura = '';
        let servicio_apertura = '';
        if (hora < 8) {
            hora_apertura = '08:00';
            servicio_apertura = 'desayunos';
        } else if (hora >= 16 && hora < 20) {
            hora_apertura = '20:00';
            servicio_apertura = 'cenas';
        }
        momento_Actual = 'Cerrado';
        // mensajes cuando el restaurante esta cerrado
        console.log(`\nSon las ${hora_minuto} y el restaurante BOTTEGA esta actualmente cerrado`);
        console.log(`La siguiente apertura sera a las ${hora_apertura} y daremos servicio de ${servicio_apertura}`);
        console.log('Nuestro horario de apertura es el siguiente:\n08:00-16:00 y 20:00-23:00');
    }

    // Presentacion inicial al usuario solo si esta en horario de apertura
    if (momento_Actual != 'Cerrado') {
        console.log("\nBienvenido/a al restaurante BOTTEGA");
